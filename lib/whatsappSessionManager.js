...
const {
    default: makeWASocket,DisconnectReason,fetchLatestBaileysVersion,jidNormalizedUser,Browsers,proto,
} = pkg;
...
import { encryptMessage } from './data_security.js';
dotenv.config();
...
function getDisplayName(contact, jid, pushName) {
